    ...
    @endif                            </div>
        ...
        <div class="custom-table mb-4">
            <div class="p-4 d-flex justify-content-between align-items-center">
                ...
                <div class="text-muted small">
                    Showing {{ $sales->firstItem() ?? 0 }} to {{ $sales->lastItem() ?? 0 }} of {{ $sales->total() ?? 0 }} entries
                </div>
            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-circle bg-{{ $sale->customer_type == 'wholesale' ? 'primary' : 'info' }} text-white me-2">
                                            {{ strtoupper(substr($sale->customer->name, 0, 1)) }}
                                        </div>
                                        <div>
                                            <div class="fw-semibold">{{ $sale->customer->name }}</div>
                                            <div class="text-muted small text-capitalize">{{ $sale->customer_type }}</div>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <button class="btn btn-action btn-primary" wire:click="viewSaleDetails({{ $sale->id }})">
                                        <i class="bi bi-eye"></i>
                                    </button>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="8">
                                    <div class="empty-state">
                                        <img src="{{ asset('images/no-data.svg') }}" alt="No Data" class="empty-state-icon">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title d-flex align-items-center">
                        ...
                        Sale Details - <span class="ms-2 invoice-number">{{ $selectedSale->invoice_number ?? '' }}</span>
                    </h5>
                            ...
                            <div class="col-md-6">
                                <div class="info-card">
                                    ...
                                    <div class="d-flex align-items-center mb-3">
                                        <div class="avatar-circle bg-{{ $selectedSale->customer_type == 'wholesale' ? 'primary' : 'info' }} text-white me-3" style="width: 50px; height: 50px; font-size: 18px;">
                                            {{ strtoupper(substr($selectedSale->customer->name, 0, 1)) }}
                                        </div>
                                        <div>
                                            <h5 class="mb-0 fw-bold">{{ $selectedSale->customer->name }}</h5>
                                            <p class="text-muted mb-0 text-capitalize">{{ $selectedSale->customer_type }} Customer</p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div>{{ \Carbon\Carbon::parse($selectedSale->created_at)->format('d M Y, h:i A') }}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="info-card">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div>
                                                    <span class="status-badge badge-{{ $selectedSale->payment_status }}">
                                    ...
                                    @if($selectedSale->payment_status != 'unpaid')
                                        <div class="mt-3">
                                            @php
                                                $paymentPercentage = round((($selectedSale->total_amount - $selectedSale->due_amount) / $selectedSale->total_amount) * 100);
                                            @endphp
                                            <div class="d-flex justify-content-between align-items-center mb-1">
                                                <span class="text-muted small">Payment Progress</span>
                                                <span class="badge bg-{{ $paymentPercentage == 100 ? 'success' : 'warning' }}">{{ $paymentPercentage }}%</span>
                                            </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <div class="fw-semibold">{{ $item->brand }} {{ $item->watch_name }}</div>
                ...
                <div class="modal-footer">
                    ...
                    <a href="{{ route('receipts.download', ['id' => $selectedSale->id ?? 0]) }}" class="btn btn-success btn-action" target="_blank">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            window.printInvoice = function() {
                ...
                const buttons = printContent.querySelectorAll('.modal-footer button, .modal-footer a, .btn-close');
