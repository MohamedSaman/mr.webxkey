...
class StaffDashboard extends Component
{
    ...
    protected function loadProductInventory($userId)
    {
        $this->productInventory = DB::table('staff_products')
            ...
            ->groupBy('staff_products.watch_id', 'watch_details.name', 'watch_details.model', 
                     'watch_details.code', 'watch_details.brand', 'watch_details.image')
            ->get();
    }
