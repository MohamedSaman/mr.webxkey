                                        ...
                                        <tr
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div
                                                        ...
                                                        <span
                                                            class="text-primary fw-bold">{{ substr($payment->sale->customer->name, 0, 1) }}</span>
                                                    </div>
                                                    <div>
                                            ...
                                            <td>
                                                ...
                                                @if (now()->gt($payment->due_date))
                                                    <span class="badge bg-danger bg-opacity-10 text-danger text-xs mt-1">
                                                        {{ now()->diffForHumans($payment->due_date, ['parts' => 1]) }}
                                                        overdue
                                                    </span>
                                                ...
                                                @else
                                                    <span class="badge bg-info bg-opacity-10 text-info text-xs mt-1">
                                                        Due in {{ now()->diffForHumans($payment->due_date, ['parts' => 1]) }}
                                                    </span>
                                                @endif
                                            </td>
                                            ...
                                            <td class="text-center">
                                                @if ($payment->status === null)
                                                    <div class="btn-group">
                                                        ...
                                                        <button
                                                            class="btn btn-sm btn-outline-warning rounded-pill ms-2"
                                                ...
                                                @elseif($payment->status === 'pending')
                                                    <span
                                                        class="btn btn-sm btn-warning rounded-pill disabled opacity-75">
                                                ...
                                                @else
                                                    <span
                                                        class="btn btn-sm btn-success rounded-pill disabled opacity-75">
                            ...
                            <div class="col-md-3 bg-light p-4 border-end">
                                ...
                                <div class="mb-3">
                                    ...
                                    <p class="mb-2 d-flex justify-content-between">
                                        ...
                                        <span
                                            class="{{ now()->gt($paymentDetail->due_date) ? 'text-danger fw-bold' : '' }}">
                                                    ...
                                                    @elseif($paymentDetail->due_payment_attachment)
                                                        <div class="position-relative">
                                                            @if(pathinfo($paymentDetail->due_payment_attachment, PATHINFO_EXTENSION) === 'pdf')
                                                                <div class="d-flex flex-column align-items-center p-4">
                                                                    <i class="bi bi-file-earmark-pdf text-danger fs-1 mb-2"></i>
                                                                    <a href="{{ asset('storage/' . $paymentDetail->due_payment_attachment) }}" 
